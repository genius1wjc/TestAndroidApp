            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (text) {
                    case "SpannableString":
                        ...
                        break;
                    case "Anim RecyclerView":
                        startActivity(new Intent(ProfileActivity.this, AnimRecyclerViewActi.class));
                        break;
                    case "DayNight Theme":
                        startActivity(new Intent(ProfileActivity.this, DayNightActi.class));
                        break;
                    case "Future Callable":
                        startActivity(new Intent(ProfileActivity.this, FutureCallableActi.class));
                        break;
                    case "PopupMenu":
                        startActivity(new Intent(ProfileActivity.this, PopupMenuActi.class));
                        break;
                    case "Keyboard":
                        startActivity(new Intent(ProfileActivity.this, KeyboardActi.class));
                        break;
                    case "Master Details":
                        startActivity(new Intent(ProfileActivity.this, ItemListActivity.class));
                        break;
                    case "HandlerThread":
                        startActivity(new Intent(ProfileActivity.this, HandlerThreadActi.class));
                        break;
                    case "WindowManager":
                        startActivity(new Intent(ProfileActivity.this, WindowManagerActi.class));
                        break;
                    case "JobScheduler":
                    ...
                    case "Generics":
                        ...
                        break;
                    case "Phrase":
                        startActivity(new Intent(ProfileActivity.this, PhraseActivity.class));
                        break;
                    case "CoordinatorLayout":
                        startActivity(new Intent(ProfileActivity.this, CoordinatorActi.class));
                        break;
                    case "SurfaceView":
                        startActivity(new Intent(ProfileActivity.this, SurfaceViewActi.class));
                        break;
                    case "Picasso":
                        startActivity(new Intent(ProfileActivity.this, PicassoActi.class));
                        break;
                    case "Share":
                        startActivity(new Intent(ProfileActivity.this, ShareActivity.class));
                        break;
                    case "Wake Lock":
                        startActivity(new Intent(ProfileActivity.this, WakeLockActi.class));
                        break;
                    case "Otto":
                        startActivity(new Intent(ProfileActivity.this, OttoActivity.class));
                        break;
                    case "Clipboard":
                        startActivity(new Intent(ProfileActivity.this, ClipboardActi.class));
                        break;
                    case "Retrofit":
                        startActivity(new Intent(ProfileActivity.this, RetrofitActi.class));
                        break;
                    case "PDF":
                        startActivity(new Intent(ProfileActivity.this, PDFActivity.class));
                        break;
                    case "Looper":
                    ...
                    case "ScrollViews":
                        ...
                        break;
                    case "WebView":
                        startActivity(new Intent(ProfileActivity.this, WebViewActi.class));
                        break;
                    case "Canvas":
                        startActivity(new Intent(ProfileActivity.this, CanvasActivity.class));
                        break;
                    case "Hyperlink":
                        startActivity(new Intent(ProfileActivity.this, HyperlinkActi.class));
                        break;
                    case "OnMeasure/OnLayout":
                        startActivity(new Intent(ProfileActivity.this, OnMeasureLayoutActi.class));
                        break;
                    case "Drag and Drop":
